...
const commandSpecificHelp = (command) => {
    if (command === "b" || command === "build") {
        ...
        log("");
        log("       In the third form, it builds the entire project while watching for changes to");
        log("       files in the source folder.");
        log("");
        log("       In the fourth form, it builds the entire project while watching for changes to");
