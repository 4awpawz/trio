...
const commonMetadata = (metadata) => {
    ...
    metadata.matter.data.title = metadata.matter.data.title || "Document";
    ...
    metadata.matter.excerpt = mdToHtml(metadata.path, metadata.matter.excerpt);
...
module.exports = resolvedFragmentStats => {
    ...
    for (const resolvedFragmentStat of resolvedFragmentStats) {
        ...
        // validate fragments have required front matter properties
