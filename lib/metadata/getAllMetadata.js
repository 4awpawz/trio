...
module.exports = () => {
    ...
    siteMetadata.frags = metadata.map(metadata => {
        return commonMetadata(blogMetadata(metadata));
    });
    return siteMetadata;
};
