/**
 * metrics allows you to create named timers that can be started,
 * paused, restarted, and stoped which can record elapsed times
 * to use for detailed metrics reporting.
 *
