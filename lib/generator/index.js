...
// Bug: rename config.public to config.publicFolder
// ToDo: eliminate release & add its unique procsses to both build & serve as options
// ToDo: HTML tag-specific callbacks with data in lieu of/in addition to fragment/include callbacks?
// ToDo: eliminate the use of data-trio-link and automatically add baseUrl to all internal relative URIs?
