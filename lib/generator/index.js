...
// ToDo: provide command option to create scaffolding application when creating a new project.
// ToDo: provide command options to create assets: i.e template, fragment, include, callback?
...
// ToDo: add the ability to pass data from a tag to a tag-based callbacks using data-trio-value="{\"someValue": some_value}\"" added to the ctx as value?
...
// Items Addressed:
// ToDo: formalize archive pages into the project just like tag and category pages are!
// ToDo: get rid of id: it can't be consistent across incremental builds and url can be used in its place as can any item that is unique.
// ToDo: destination paths and urls should all be lower case!
// ToDo: move set article date to getAllMetadata::blogMetadata!
// ToDo: rename callback argument $ to $page!
...
// ToDo: formalize informative, error message logging!
...
// ToDo: Bug - assets marked as wips breaks release build - refactor how wips are handled!
...
// ToDo: rename config mdFrontMatterDelimiters to frontMatterDelimiters, mdFrontMatterSeparator to frontMatterSeparator!
