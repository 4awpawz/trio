...
const prepareForReleaseBuild = require("./prepareForReleaseBuild");
...
module.exports = async () => {
    ...
    process.env.TRIO_ENV_buildType === "release" && await prepareForReleaseBuild();
    ...
    if (process.env.TRIO_ENV_buildIncrementally === "incremental-build" && doesCachedStatsFileExists()) {
        const oldStats = readCache(statsFileName);
