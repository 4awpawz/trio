...
// Items Addressed:
// ToDo: get rid of id: it can't be consistent accross incremental builds and url can be used in its place as can any item that is unique.
// ToDo: destination paths and urls should all be lower case!
// ToDo: move set article date to getAllMetadata::blogMetadata!
// ToDo: rename callback arguement $ to $page!
