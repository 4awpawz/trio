...
module.exports = async () => {
    ...
    metrics.startTimer("copy other files");
    copyOtherFiles();
    metrics.stopTimer("copy other files");

    metrics.startTimer("javascript bundling");
    await jsBundler();
    metrics.stopTimer("javascript bundling");

    metrics.startTimer("sass compiling");
    await sassRender();
    metrics.stopTimer("sass compiling");
