...
if (options.nojekyll) {
    warn("The use of the 'nojekyll' option in trio.json is deprecated. Use 'source\\etc' folder instead. See https://4awpawz.github.io/trio-docs-pages/docs/learn/configuration/#nojekyll for details.");
}
